          ...
          <li className={Styles.orderData__packet} key={packet.namePacket}>
            <ul className={Styles.orderData__containerPacket}>
              <li className={Styles.orderData__describePacket}>
                Package: <span className={Styles.orderData__describePacket_span}>{packet.namePacket}</span>
              </li>
              <li className={Styles.orderData__describePacket}>
                Category: <span className={Styles.orderData__describePacket_span}>{packet.photosessionType}</span>
              </li>
              <li className={Styles.orderData__describePacket}>
                Cost, $: <span className={Styles.orderData__describePacket_span}>{packet.price}</span>
              </li>
              {orderInMyProfile && (
                <li className={Styles.orderData__describePacket}>
                  Ссылка:
