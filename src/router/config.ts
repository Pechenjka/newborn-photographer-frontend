...
export const routes: IRoute[] = [
  ...
  { component: AboutMe, path: "aboutMe", name: "aboutMe", isAdmin: false, isAuth: false },
  {
    ...
    path: "photoGallery/",
    // subRoutes: [
    //   { path: "newborn", name: "newborn"},
    //   { path: "pregnancy", name: "pregnancy" },
    //   { path: "baby", name: "baby" },
    //   { path: "family", name: "family" },
    //   { path: "woman", name: "woman" },
    //   { path: "discharge", name: "discharge" },
    //   { path: "christening", name: "christening" }
    // ],
   subPath: ["newborn", "pregnancy", "baby", "family", "woman", "discharge", "christening"],
    name: "photoGallery",
    isAdmin: false,
    isAuth: false,
  },
 ...
 // { component: NotFound, path: "*", name: "not-found", isAdmin: false, isAuth: false },
